const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://wcny68.itututec.eu.org' },
    { title: '访问文档中心获取更多帮助', url: 'https://wcny68.itututec.eu.org/about' }
  ],
  ...
  HEO_SOCIAL_CARD_ICON3: 'fa fa-telegram',
  HEO_SOCIAL_CARD_URL: 'https://t.me/+w6bWo3Hwf6pkNDBl',
